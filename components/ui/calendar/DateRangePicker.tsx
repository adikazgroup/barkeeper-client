...
const DateRangePicker = forwardRef<HTMLInputElement, DateRangePickerProps>(
  (
    ...
    const calculateDropdownPosition = useCallback(() => {
      ...
      setHasCoords(true);
    }, [responsiveWidth, getCalendarWidth, setDropdownStyle, setHasCoords]);
    ...
    }, [isOpen, isVisible, dropdownStyle.top]);
          ...
          <div className="flex flex-1 gap-1">
            <div className="flex-1 min-w-[90px]">
              <SimpleSelect
                ...
                placeholder="Month"
                className="h-8 border-border rounded-md bg-gray-100 dark:bg-[#3d3d3d]"
              />
            </div>
