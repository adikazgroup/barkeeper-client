...
/**
 * Generic row-placeholder skeleton with no column awareness. For a real data
 * table, prefer components/ui/table/TableSkeleton.tsx, which mirrors the
 * actual column layout (widths, alignment, "actions" column) instead of a
 * fixed 4-column grid.
 */
